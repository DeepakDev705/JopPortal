...
const JobDescription = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto my-10">
      ...
      <div className="my-4">
        <h1 className="font-bold my-1 capitalize">Role:{" "}<span className="pl-4 font-normal text-gray-800">{singleJob?.title} </span></h1>
        <h1 className="font-bold my-1 capitalize">Location:{" "}<span className="pl-4 font-normal text-gray-800"> {singleJob?.location}</span></h1>
